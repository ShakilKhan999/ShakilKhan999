...
### 3️⃣ **Wellness App (Ongoing)**
- **Problem:** Hard to sync Apple Watch data with Flutter apps.  
- **Solution:** Integrated **HealthKit APIs + Firebase** and added **AI tips**.  
- **Impact:** Personalized insights, cross-device wellness tracking.  
🔗 [GitHub Repo](#)
...
- **Impact:** Faster iterations, successful early client testing.  
🔗 [GitHub Repo](#)
